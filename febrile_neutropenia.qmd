...
![](images_FNspec/cdifficile.png){fig-align="center" width="250"}
...
- Limited data for fecal microbiota transplant, bezlotoxumab
...
![](images_FNspec/entercolitis.png){fig-align="center"}
...
## Do all patients benefit from FQ prophylaxis / <br> BSI reduction?
...
<br> <br> <br> ::: aside ECIL-10 systematic review confirms highest
rates of resistance in **South-Eastern Europe** and a significant
temporal increase in ESBL/3GCR, CR *K. pneumoniae*, and MDR *P.
aeruginosa* over the past decade. [@baccelli2025] :::
...
![](images_FNspec/roman.png){fig-align="center"}

Roman (Constantine) Calendar<br> <br> <br>
...
![](images_FNspec/Lancet.png){fig-align="center"}

<br>

- FUO patients afebrile and clinically stable for 72 h after start of
  empiric therapy could safely stop antimicrobial therapy vs. continue
  untile resolution of neutropenia
...
## Timeline of infection risk after allogeneic HSCT
...
- Influenza
- Para-influenza
- RSV <br> <br> Drugs that suppress cell-mediated immunity: purine
  analogues (e.g., fludarabine, 2-CDA, clofarabine), alemtuzumab,
  corticosteroids (\>20 mg prednisone equivalent for \>2 weeks), TNF-α
  inhibitors…
:::
:::::
...
![](images_FNspec/cns.png){fig-align="center" width="350"}
...
![](images_FNspec/targeted.png){fig-align="center" width="800"}
...
![](images_FNspec/carT.png){fig-align="center" width="800"}

## Infection risk with CAR-T therapy

<br>

![](images_FNspec/inf_carT.png){fig-align="center" width="500"}
...
![](images_FNspec/checkpoint.png){fig-align="center"}
...
# Invasive fungal infections {background-color="#b20e10"}

## Problem: non-specificity of CT findings

<br>

![](images_FNspec/non_spec.png){fig-align="center"}
...
## CT pulmonary angiography (CTPA) can improve specificity <br> for imaging of invasive mold disease

<br>

**Fungal angioinvasion and vessel thrombosis**

![](images_FNspec/angioinvasion.png){fig-align="center" width="800"}
...
![](images_FNspec/vos_1.png){fig-align="center" width="800"}
...
![](images_FNspec/vos_2.png){fig-align="center" width="800"}
...
![](images_FNspec/PET.png){fig-align="center" width="800"}
...
![](images_FNspec/breakthrough_fif.png){fig-align="center" width="800"}
...
![](images_FNspec/mucor.jpg){fig-align="center" width="800"}

## CT-specific findings for mucormycosis?

<br>

![](images_FNspec/mucor_CT.png){fig-align="center" width="800"}

- Multiple bilateral nodular infiltrates

# Final thoughts: what to do with persistent fever? {background-color="#b20e10"}
